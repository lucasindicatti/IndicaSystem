                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="per_page" id="theme">
                                    ...
                                    <option value="100000" <?= $configuration['per_page'] == '100000' ? 'selected' : ''; ?>>100.000</option>
                                </select>
                            ...
                            <div class="span8">
                                <div class="span9" style="display:flex">
                                    ...
                                    <button href="#modal-confirmaratualiza" data-toggle="modal" type="button" class="button btn btn-danger">
                                      <span class="button__icon"><i class="bx bx-sync"></i></span><span class="button__text2">Atualizar IndicaSys</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div id="modal-confirmaratualiza" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form action="<?php echo base_url() ?>index.php/clientes/excluir" method="post">
        ...
        <div class="modal-footer" style="display:flex;justify-content: center">
          ...
          <button id="update-indicasys" type="button" class="button btn btn-warning"><span class="button__icon"><i class="bx bx-sync"></i></span><span class="button__text2">Atualizar</span></button>
        </div>
    </form>
</div>
<!-- Modal -->
...
<script>
    ...
    $('#update-indicasys').click(function() {
