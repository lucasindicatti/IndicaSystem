            ...
            <div class="widget-content nopadding tab-content">
                <div class="span12" id="divProdutosServicos" style=" margin-left: 0">
                    <ul class="nav nav-tabs">
                        <li id="tabDetalhes"><a href="#tab1" data-toggle="tab">Detalhes da Venda</a></li>
                            ...
                            <div class="span12" id="divEditarVenda">
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        ...
                                        <textarea name="observacoes" id="observacoes" cols="30" rows="5" style="width: 339px; height: 78px;"><?php echo $result->observacoes ?></textarea>
                                    </div>
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        ...
                                        <textarea name="observacoes_cliente" id="observacoes_cliente" cols="30" rows="5" style="width: 339px; height: 78px;"><?php echo $result->observacoes_cliente ?></textarea>
                                    </div>
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span8 offset2" style="text-align: center;display:flex; flex-wrap: wrap">
                                            ...
                                            <button class="button btn btn-primary" id="btnContinuar">
                                                <span class="button__icon"><i class="bx bx-sync"></i></span><span class="button__text2">Atualizar Venda</span></button>
                                            <a href="<?php echo base_url() ?>index.php/vendas/visualizar/<?php echo $result->idVendas; ?>" class="button btn btn-primary">
                                                <span class="button__icon"><i class="bx bx-show"></i></span><span class="button__text2">Imprimir Venda</span></a>
                                    ...
                                    <form id="formProdutos" action="<?php echo base_url(); ?>index.php/vendas/adicionarProduto" method="post">
                                        ...
                                        <div class="span2">
                                            ...
                                            <button class="button btn btn-success" id="btnAdicionarProduto">
                                                <span class="button__icon"><i class='bx bx-plus-circle'></i></span><span class="button__text2">Adicionar Produto</span></button>
                                        </div>
                                    </form>
                                </div>
                                <div class="span11">
                                    <form id="formDesconto" action="<?php echo base_url(); ?>index.php/vendas/adicionarDesconto" method="POST">
                                        ...
                                        <div class="span2">
                                            ...
                                            <button class="button btn btn-success" id="btnAdicionarDesconto">
                                                <span class="button__icon"><i class='bx bx-plus-circle'></i></span><span class="button__text2">Aplicar Desconto</span></button>
                                        </div>
