                            ...
                            <div class="span12" id="divCadastrarOs">
                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formVendas">
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        ...
                                        <textarea name="observacoes" id="observacoes" cols="30" rows="5" style="width: 339px; height: 78px;"></textarea>
                                    </div>
                                    ...
                                    <div class="span6" style="padding: 1%; margin-left: 0">
                                        ...
                                        <textarea name="observacoes_cliente" id="observacoes_cliente" cols="30" rows="5" style="width: 339px; height: 78px;"></textarea>
                                    </div>
